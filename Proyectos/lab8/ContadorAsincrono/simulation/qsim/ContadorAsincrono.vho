...
-- max[3]	=>  Location: PIN_J15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- max[2]	=>  Location: PIN_F13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- R[0]	=>  Location: PIN_C16,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- en	=>  Location: PIN_B16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- R[1]	=>  Location: PIN_F14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- R[2]	=>  Location: PIN_D16,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \cnt~0_combout\ = (\ld~input_o\ & ((\R[0]~input_o\))) # (!\ld~input_o\ & (!cnt(0)))
...
-- Equation(s):
-- \cnt[3]~1_combout\ = (\ld~input_o\) # (\en~input_o\)
...
-- Equation(s):
-- \cnt~2_combout\ = (\ld~input_o\ & (\R[1]~input_o\)) # (!\ld~input_o\ & ((cnt(1) $ (cnt(0)))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (\max[1]~input_o\ & (cnt(1) & (cnt(0) $ (!\max[0]~input_o\)))) # (!\max[1]~input_o\ & (!cnt(1) & (cnt(0) $ (!\max[0]~input_o\))))
...
-- Equation(s):
-- \cnt~3_combout\ = (!\ld~input_o\ & (cnt(2) $ (((cnt(0) & cnt(1))))))
...
-- Equation(s):
-- \cnt~4_combout\ = (\cnt~3_combout\) # ((\ld~input_o\ & \R[2]~input_o\))
...
-- Equation(s):
-- \cnt~5_combout\ = (\ld~input_o\ & (\R[3]~input_o\)) # (!\ld~input_o\ & (((!cnt(0)) # (!cnt(2)))))
...
-- Equation(s):
-- \cnt~6_combout\ = (\ld~input_o\ & (((\cnt~5_combout\)))) # (!\ld~input_o\ & (cnt(3) $ (((cnt(1) & !\cnt~5_combout\)))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (cnt(3) & (\max[3]~input_o\ & (cnt(2) $ (!\max[2]~input_o\)))) # (!cnt(3) & (!\max[3]~input_o\ & (cnt(2) $ (!\max[2]~input_o\))))
